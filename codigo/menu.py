...
class Menu():
    ...
    def menu_volume(self):
        ...
        while rodando:
            ...
            # Cria novos textos a cada frame
            texto_musica = Texto(
                24,
            ...
            pygame.draw.rect(
                self.__tela.display,
                (200, 200, 200),
                (self.__som.x_barra_volume, self.__som.y_barra_musica, self.__som.largura_barra_volume, self.__som.altura_barra_volume)
            )
            ...
            pygame.draw.rect(
                self.__tela.display,
                (200, 200, 200),
                (self.__som.x_barra_volume, self.__som.y_barra_efeitos, self.__som.largura_barra_volume, self.__som.altura_barra_volume)
            )
